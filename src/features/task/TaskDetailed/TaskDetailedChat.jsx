...
import TaskDetailedChatForm from "./TaskDetailedChatForm";

class TaskDetailedChat extends Component {
  state = {
    showReplyForm: false,
  ...
  render() {
    const { addTaskComment, taskId, taskChat } = this.props;
...
export default TaskDetailedChat;
