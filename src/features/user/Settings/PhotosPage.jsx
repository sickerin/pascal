...
//allow us to write deeply nested function transformations without drifting code (makes code neat)
...
class PhotosPage extends Component {
  ...
  //async needed to get error back
  ...
  cropImage = () => {
    ...
    // note below isn't supported by IE Explorer
